...
// ----- Stolen from evio.h -----------
#define swap64(x)                                                                                                      \
	((((x) >> 56) & 0x00000000000000FFL) | (((x) >> 40) & 0x000000000000FF00L) | (((x) >> 24) & 0x0000000000FF0000L) | \
	 (((x) >> 8) & 0x00000000FF000000L) | (((x) << 8) & 0x000000FF00000000L) | (((x) << 24) & 0x0000FF0000000000L) |   \
	 (((x) << 40) & 0x00FF000000000000L) | (((x) << 56) & 0xFF00000000000000L))
...
public:
	...
	enum BLOCKTYPE { kBT_UNKNOWN, kBT_BOR, kBT_EPICS, kBT_SYNC, kBT_PRESTART, kBT_GO, kBT_PAUSE, kBT_END, kBT_PHYSICS };
